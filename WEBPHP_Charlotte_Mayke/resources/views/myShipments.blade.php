            ...
            <div class="row" style="margin:0 auto; text-align: center;  justify-content: center">
                <div class="col-sm-8" style="text-align: center;">
                    @if (isset($shipments))
                        @if($shipments->count() > 0 && $shipments[0] != null)
                            {{--                    TODO only if logged in--}}
                            <h4 style="text-align: center"><strong>Shipment</strong></h4>
                            <div>
                                <table class="table" style="width: 50%; margin: auto;">
                                    <thead>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        @if($shipments[0]->status == "Afgeleverd" && $shipments[0]->stars == null)
                                            <form action="{{route('writeReview')}}" method="get">
                                                @csrf
                                                <td>
                                                    <button type="submit" value="submit" class="btn btn-dark">Write a review</button>
                                                </td>
                                                <input hidden value="{{ $shipments[0]->id }}" name="id"><br><br>
                                            </form>
                                        @endif
                        ...
                        @else
                            <h4 style="text-align: center"><strong>Shipment</strong></h4>
                            <div>
                                <p>Could not find any shipments with this Track and Trace code.</p>
                            </div>
                        @endif
                    @else
                        <div>
                            <h4 style="text-align: center"><strong>Follow your package</strong></h4>
                            <form action="{{route('myShipmentsGet')}}" method="post">
                                @csrf
                                <p>Track & Trace code</p>
                                <input type="text" name="code"><br><br>
                                <button type="submit" value="submit" class="btn btn-dark">Follow your package</button>
                            </form>
                        </div>
                    @endif
                </div>
